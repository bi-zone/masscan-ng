/*
    ...
    This is an implementation of the core Masscan-ng scanning algorithm
    in JavaScript/NodeJS. The core scanning algorithm is what makes
    Masscan-ng unique from other scanners, so it's worth highlighting
    ...
    Masscan-ng is an asynchronous, probe-at-a-time scanner. It spews out
    ...
    open on a single host, they have to post-process the masscan-ng output
    themselves, because masscan-ng doesn't do it.
    ...
    THE WAY MASSCAN-NG WORKS

    Masscan-ng first stores the targets as a "list of ranges". IP address
...
Targets, RangeList, Range
    ...
    A RangeList is just an array of Ranges. In Masscan-ng, this object
