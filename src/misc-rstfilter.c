...
int rstfilter_is_filter(struct ResetFilter *rf, const ipaddress *src_ip,
                        unsigned src_port, const ipaddress *dst_ip,
                        unsigned dst_port) {
  ...
  case 6:
    ...
    input[4] = (((unsigned short)src_port) << 16) | dst_port;
    break;
  default:
