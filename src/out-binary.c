...
/****************************************************************************
 ****************************************************************************/
static void binary_out_open(struct Output *out) {
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_close(struct Output *out) {
  char firstrecord[2 + 'a'];
  size_t bytes_written;
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_status_ipv6(struct Output *out, time_t timestamp,
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_status(struct Output *out, time_t timestamp,
                              enum PortStatus status, const ipaddress *ip,
  ...
  if (ip->version == 6) {
    binary_out_status_ipv6(out, timestamp, status, ip, ip_proto, port, reason,
                           ttl);
    return;
  }
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_banner_ipv6(struct Output *out, time_t timestamp,
  ...
  bytes_written = fwrite(&foo, 1, length + i + HeaderLength, out->fp);
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_banner(struct Output *out, time_t timestamp,
                              const ipaddress *ip, unsigned ip_proto,
  ...
  if (ip->version == 6) {
    binary_out_banner_ipv6(out, timestamp, ip, ip_proto, port, proto, ttl, px,
                           length);
    return;
  }
...
/****************************************************************************
 ****************************************************************************/
const struct OutputType binary_output = {"scan",
                                         NULL,
                                         binary_out_open,
                                         binary_out_close,
                                         binary_out_status,
