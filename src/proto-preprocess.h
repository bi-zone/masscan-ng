...
#define ETH_FRAME_LEN (ETH_DATA_LEN + ETH_HLEN)
...
struct PreprocessedInfo {
  ...
  size_t ip_offset;     /* 14 for normal Ethernet */
  ...
  size_t app_offset; /* start of TCP payload */
  size_t app_length; /* length of TCP payload */
