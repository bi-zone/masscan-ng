...
#define GETBYTE(R, n) ((((R) >> ((n)*8)) ^ (seed) ^ (r)) & 0xFF)
  ...
  r0 = (uint64_t)sbox[GETBYTE(R, 0)] << 0 | (uint64_t)sbox[GETBYTE(R, 1)] << 8;
  r1 = ((uint64_t)sbox[GETBYTE(R, 2)] << 16UL | (uint64_t)sbox[GETBYTE(R, 3)]
                                                    << 24UL) &
       0x0ffffFFFFUL;
  r2 = (uint64_t)sbox[GETBYTE(R, 4)] << 0 | (uint64_t)sbox[GETBYTE(R, 5)] << 8;
  r3 = ((uint64_t)sbox[GETBYTE(R, 6)] << 16UL | (uint64_t)sbox[GETBYTE(R, 7)]
                                                    << 24UL) &
       0x0ffffFFFFUL;
