...
/***************************************************************************
 ***************************************************************************/
uint64_t syn_cookie(const ipaddress *ip_them, unsigned port_them,
                    const ipaddress *ip_me, unsigned port_me,
                    uint64_t entropy) {
...
/***************************************************************************
 ***************************************************************************/
uint64_t syn_cookie_ipv4(const ipv4address_t *ip_them, unsigned port_them,
...
/***************************************************************************
 ***************************************************************************/
uint64_t syn_cookie_ipv6(const ipv6address_t *ip_them, unsigned port_them,
  ...
  data[2] = ip_me->hi;
  data[3] = ip_me->lo;
  data[4] = (((uint64_t)(port_them & 0xFFFF)) << 16ULL) | port_me;
  return siphash24(data, sizeof(data), x);
}
