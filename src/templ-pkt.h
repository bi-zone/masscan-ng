 ...
 *      Indexes in the table see in massip-ports.h
 * @param seqno
 ...
 */
void template_set_target_ipv4(struct TemplateSet *templset,
...
void template_set_target_ipv6(struct TemplateSet *templset,
...
size_t tcp_create_packet(struct TemplatePacket *pkt, const ipaddress *ip_them,
