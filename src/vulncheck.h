...
struct MassVulnCheck {
  ...
  /* The hello packet template lengthn */
  size_t packet_length;

  /* Called to change the template based upon the target */
  void (*set_target)(struct TemplatePacket *tmpl, const ipv4address_t *ip_them,
                     unsigned port_them, const ipv4address_t *ip_me,
                     unsigned port_me, unsigned seqno, unsigned char *px,
